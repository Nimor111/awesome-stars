...
- [nix-community/neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) - [maintainer=@Kranzes, @teto, @GaetanLepage, @willruggiano]
...
- [nsaunders/purescript-typedenv](https://github.com/nsaunders/purescript-typedenv) - Type-directed environment parsing
...
- [bennetthardwick/dotfiles](https://github.com/bennetthardwick/dotfiles) - Gruvbox inspired Arch Linux Hyprland rice.
...
- [alshdavid/pico-router](https://github.com/alshdavid/pico-router) - Simple framework agnostic UI router for SPAs
